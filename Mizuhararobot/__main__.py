...
PM_START_TEXT = """
Hi {}, my name is {}! 
I am ဘူညီလေး bot.Rent me for your group if you want😃😃.
You can find my list of available commands with /help.
"""


BOT_IMG = "https://telegra.ph/file/c229568ea7a9958361e2e.jpg"




HELP_STRINGS = """
Hello I'm  ဘူညီလေး. Rent me for your grp to have fun there.You can have a look at the following for an idea of some of \
the things I can help you with.

*Main* commands available:[:.:](https://telegra.ph/file/c229568ea7a9958361e2e.jpg)
...
def start(update, context):
    if update.effective_chat.type == "private":
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="➕️Add ဘူညီလေး to your group",
                            url="t.me/{}?startgroup=true".format(context.bot.username))
                    ],
                    [
                        InlineKeyboardButton(
                            text="ဘူကောင် ငနံ",
                            url="https://t.me/@olo_pl_ya_mal"),
                        InlineKeyboardButton(
                            text="ဘူကောင်ငခန့်",
                            url="https://t.me/@Minkhantk")
                    ],
                    [
                        InlineKeyboardButton(
                            text="help",
                            url="https://t.me/Antithesis_own_bot?start=help")
                    ]]))
        ...
        update.effective_message.reply_text("Heya, my name is ဘူညီလေး")
